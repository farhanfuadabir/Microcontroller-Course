...
#define LCD_D5	4	//define MCU pin connected to LCD D5
#define LCD_D6	5	//define MCU pin connected to LCD D6
#define LCD_D7	6	//define MCU pin connected to LCD D7
