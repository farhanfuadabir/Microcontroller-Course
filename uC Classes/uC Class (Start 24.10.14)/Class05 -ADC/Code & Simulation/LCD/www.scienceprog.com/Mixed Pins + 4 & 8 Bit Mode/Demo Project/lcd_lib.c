...
void LCDinit(void)	//Initializes LCD 
{
	   ...
	   //---------one------
		...
		/*LDP = 0 << LCD_D7 | 0 << LCD_D6 | 1 << LCD_D5 | 1 << LCD_D4 | 1 << LCD_D3 | 0 << LCD_D2 | 0 << LCD_D1 | 0 << LCD_D0;
		LCP |= 1 << LCD_E | 0 << LCD_RW | 0 << LCD_RS;
		_delay_ms(1);
	   ...
	   //-----increment address, invisible cursor shift------
		LCDsendCommand(0b00001100);
		/*LDP = 0 << LCD_D7 | 0 << LCD_D6 | 0 << LCD_D5 | 0 << LCD_D4 | 1 << LCD_D3 | 1 << LCD_D2 | 0 << LCD_D1 | 0 << LCD_D0; 
		LCP |= 1 << LCD_E | 0 << LCD_RW | 0 << LCD_RS;
		_delay_ms(1);
	...
	#ifdef LCD_8BIT_M //8 mixed bits part
